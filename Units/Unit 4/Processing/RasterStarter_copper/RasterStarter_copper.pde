...
String pathToImage = 
  "http://nifty.stanford.edu/2011/parlante-image-puzzle/copper-puzzle.png"; //Change this to load a different image
...
void draw()
{
  ...
  while (location < pixels.length) 
  {
    ...
    color newColor = color(0, g*20, b*20);   //create a new color
