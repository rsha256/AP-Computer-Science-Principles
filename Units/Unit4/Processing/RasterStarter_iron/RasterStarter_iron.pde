...
String pathToImage = 
  "http://nifty.stanford.edu/2011/parlante-image-puzzle/iron-puzzle.png"; //Change this to load a different image
...
void draw()
{
  ...
  while (location < pixels.length) 
  {
    ...
    color newColor = color(r*10, 0, 0);   //create a new color
